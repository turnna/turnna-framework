...
namespace Assets.Core.UI.Scripts
{
    /// <summary>
    ...
    /// <summary>
    /// The MainScreenManager manages the UI screens (View base class) using event channels
    /// paired with each View. A stack maintains a history of previously shown screens, so
    /// the MainScreenManager can "go back" until it reaches the default UI screen, the home screen.
    /// 
