...
namespace Assets.Core.Utilities.SaveLoad
{
    /// <summary>
    ...
    public static class SaveManager
    {
        ...
        // Get a list of all files in a subfolder
        public static string[] GetFiles(string subFolder = k_defaultSubFolder)
        {
            string savePath = GetSavePath(subFolder);
            ...
            Debug.LogError("SaveManager: Save folder not found at: " + savePath);
            return null;
        }
    }
}